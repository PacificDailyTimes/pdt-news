...
ALTER TABLE calendars ADD COLUMN IF NOT EXISTS kind TEXT NOT NULL DEFAULT 'caldav';
ALTER TABLE calendars ADD COLUMN IF NOT EXISTS google_access TEXT;
ALTER TABLE calendars ADD COLUMN IF NOT EXISTS google_refresh TEXT;
ALTER TABLE calendars ADD COLUMN IF NOT EXISTS google_cal TEXT NOT NULL DEFAULT 'primary';
